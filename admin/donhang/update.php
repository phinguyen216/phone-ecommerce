              ...
              <tbody>
                <?php if ($suabill): ?>
                  <tr>
                    ...
                    <td style="color: blue; font-weight: bold;"><?= $suabill['vnp_transaction_no'] ?: '-' ?></td>
                    <td><?= $suabill['vnp_bank_code'] ?: '-' ?></td>
                  </tr>
                <?php else: ?>
                  <tr>
                    <td colspan="12" style="text-align: center;">Không tìm thấy đơn hàng.</td>
                  </tr>
                <?php endif; ?>
              </tbody>
            </table>

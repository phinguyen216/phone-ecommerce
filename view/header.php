    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
        <div class="container">
            ...
            <div class="search-box d-none d-lg-flex">
                <form action="index.php?act=sanpham" method="POST" class="d-flex w-100">
                    <input type="text" name="kyw" class="form-control search-input" placeholder="Tìm kiếm sản phẩm...">
                    <button type="submit" name="timkiem" class="btn btn-light search-btn">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-center">
                    ...
                    ?>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?act=mybill">
                                <i class="fa-solid fa-box-open nav-icon"></i> Đơn hàng của tôi
                            </a>
                        </li>
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link btn btn-login rounded-pill px-3 ms-2" href="index.php?act=dangnhap">
